# Hi, I build AI automation workflows that replace manual work

I design n8n workflows and AI agents that turn slow, manual, paper-based
processes into systems that run themselves, log data, catch problems early,
and report back without anyone lifting a finger.
...
`n8n` `Python` `Flask API` `Groq` `OpenAI / Claude` `Cursor` `Airtable`
`Google Sheets` `Telegram Bot API` `Webhooks` `REST APIs`

---

## Currently

Building more AI-driven automations that replace manual, repetitive business
processes with self-running systems.
